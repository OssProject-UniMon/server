...
public class BackendAdvice {
    ...
    public UserResponseDTO methodArgumentNotValidException(MethodArgumentNotValidException e){
        return new UserResponseDTO(2); // 필수적으로 입력해야 할 칸에 입력하지 않았을 경우 serverCode == 2 (임시적으로)
    }
