...
public class UserService {
    ...
    public User save(SignupReqDTO signupReqDTO) {
        User user = new User();
        user.setNickname(signupReqDTO.getNickname());
        user.setEmail(signupReqDTO.getEmail());
        user.setPassword(signupReqDTO.getPassword());
        user.setMajor(signupReqDTO.getMajor());
        user.setGrade(signupReqDTO.getGrade());
        user.setGender(signupReqDTO.getGender());
        user.setIncomeBracket(signupReqDTO.getIncome_bracket());
        user.setScholarshipStatus(signupReqDTO.getScholarship_status());
        user.setDistrict(signupReqDTO.getDistrict());
